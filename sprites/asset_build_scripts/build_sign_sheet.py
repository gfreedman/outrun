...
── Input ──────────────────────────────────────────────────────────────────
  ...
  assets/signs/sign_turn_right.png   chevron arrow pointing right
  assets/signs/sign_turn_left.png    chevron arrow pointing left

── Outputs ────────────────────────────────────────────────────────────────

  assets/sign_sheet.png   Horizontal atlas — both signs packed into a single
...
ORDER = [
    ("TURN_RIGHT", "assets/signs/sign_turn_right.png"),   # right-curve chevron
    ("TURN_LEFT",  "assets/signs/sign_turn_left.png"),    # left-curve chevron
]
