...
Output
───────
  sprites/assets/clouds_1x.png  — horizontal strip of white clouds
  sprites/assets/clouds_2x.png
  sprites/assets/clouds_4x.png
  sprites/assets/clouds.json    — frame metadata
"""
...
SRC   = Path(__file__).parent / 'source_for_sprites' / 'clouds.jpg'
OUT   = Path(__file__).parent / 'assets'
DEBUG = Path(__file__).parent / 'source_for_sprites' / 'debug'
