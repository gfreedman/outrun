...
'source/cookie.png' and saves each as a clean transparent PNG.

── Source layout ────────────────────────────────────────────────────────────

  source/cookie.png  —  2107×496 px, RGBA.
...
── Outputs ──────────────────────────────────────────────────────────────────
  ...
  parts/billboards/billboard_cookie_monster_happy_smoking.png
  parts/billboards/billboard_cookie_monster_premium_cigs.png
  parts/billboards/billboard_cookie_monster_smokin_now.png
  parts/billboards/billboard_cookie_monster_cig_reserves.png
"""
...
print()
print("=" * 60)
print(f"DONE — 4 cookie monster billboards written to parts/billboards/")
print("=" * 60)
