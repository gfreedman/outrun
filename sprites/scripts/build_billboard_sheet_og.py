...
── Input ──────────────────────────────────────────────────────────────────
  ...
  parts/billboards/og_boards/billboard_*.png   (12 billboard PNGs, one per entry
                                                 in the ORDER list below)

── Outputs ────────────────────────────────────────────────────────────────

  dist/billboard_sheet.png   Horizontal atlas — all billboards packed into a
...
print(f"Saved dist/billboard_sheet.png  {sheet_w}x{sheet_h}")
print()
