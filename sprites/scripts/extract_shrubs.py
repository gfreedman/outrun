...
Extracts S1, S2, S6 shrub sprites from source/shrubz.png
and saves each as a transparent PNG into parts/shrubs/.
...
── Outputs ────────────────────────────────────────────────────────────────
  parts/shrubs/shrub_s1.png
  parts/shrubs/shrub_s2.png
  parts/shrubs/shrub_s6.png
"""
...
os.makedirs("parts/shrubs", exist_ok=True)
