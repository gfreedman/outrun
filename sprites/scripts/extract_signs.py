...
Extracts the turn-right and turn-left road signs from source/signz.png
and saves each as a transparent PNG into parts/signs/.
...
── Outputs ────────────────────────────────────────────────────────────────
  parts/signs/sign_turn_right.png
  parts/signs/sign_turn_left.png
"""
...
os.makedirs("parts/signs", exist_ok=True)
