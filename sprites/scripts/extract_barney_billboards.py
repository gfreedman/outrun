...
Extracts two Barney billboard sprites from 'source/barney.png':
...
── Source layout ────────────────────────────────────────────────────────────
  ...
  source/barney.png  —  848×1234 px, RGBA.
...
── Outputs ──────────────────────────────────────────────────────────────────
  ...
  parts/billboards/billboard_barney_outrun_palette.png
  parts/billboards/billboard_barney_metal_tilletire.png
"""
