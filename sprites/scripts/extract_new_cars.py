...
── Outputs ───────────────────────────────────────────────────────────────────
  ...
  dist/gottago_car_sprites.png
  dist/yoshi_car_sprites.png
  dist/banana_car_sprites.png
  dist/mega_car_sprites.png
"""
...
def extract_car(full_arr: np.ndarray, gx1: int, gy1: int,
    ...
    Image.fromarray(region).save(f"source/debug/car_{stem}_pass1.png")
    ...
    img.save(f"source/debug/car_{stem}_final.png")
    return img
...
for (row, col), stem in sorted(TARGETS.items()):
    ...
    out    = f"dist/{stem}_car_sprites.png"
