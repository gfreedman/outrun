...
── Input ──────────────────────────────────────────────────────────────────
  ...
  parts/billboards/cookie_boards/billboard_cookie_monster_*.png
  (4 portrait-orientation PNGs, one per entry in the ORDER list below)

── Outputs ────────────────────────────────────────────────────────────────

  dist/cookie_sheet.png   Horizontal atlas — 4 portrait signs packed into
...
sheet.save("dist/cookie_sheet.png")
print(f"Saved dist/cookie_sheet.png  {sheet_w}x{sheet_h}")
print()
