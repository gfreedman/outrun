...
Extracts individual house/building sprites from two source images:
  source/houses.png   — desert adobe + Tusken habitations
  source/houses2.png  — colourful pixel-art buildings

Outputs transparent PNGs to:
  parts/houses/  (adobe + desert structures)
  parts/buildings/ (colourful buildings)
"""
...
OUT_ADOBE    = "parts/houses/"
OUT_COLORFUL = "parts/buildings/"
...
print("── houses.png ──────────────────────────────────────────────")
img_h  = Image.open("source/houses.png").convert("RGBA")
...
print("\n── houses2.png ─────────────────────────────────────────────")
img_b  = Image.open("source/houses2.png").convert("RGBA")
